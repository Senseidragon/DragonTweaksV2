...
source: "[[https://wiki.minecolonies.ldtteam.com/source/buildings/hospital]]"
pipeline_stage: advisor-artifact
version: latest
---

The [[Hospital]] is where injured or sick citizens go. The Healer will heal them with various items. 
