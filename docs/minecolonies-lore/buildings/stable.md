...
source: "[[https://wiki.minecolonies.ldtteam.com/source/buildings/stable]]"
...
The Cavalrys function similarly to guards at a [[Guard Tower]], with assignable tasks such as patrol and guard. However, Cavalrys only patrol between  and Gatehouses.
