...
source: "[[https://wiki.minecolonies.ldtteam.com/source/systems/border]]"
...
> When the [[Barracks]] is level 4, and all it's [[Barracks Tower]] are level 4 as well, the radius is increased to **3 Chunks**.
