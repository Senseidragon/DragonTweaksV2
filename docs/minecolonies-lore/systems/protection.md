---
topic: Colony Protection
type: advisor-artifact
source: "[[https://wiki.minecolonies.ldtteam.com/source/systems/protection]]"
pipeline_stage: advisor-artifact
version: latest
---

Our Colony Protection System (once a [[Town Hall]] is placed) can be toggled in the config file.
...
> The protection system depends on the border system. Only areas that are within the colony's border will be protected. See the Colony Border System page for more information.
