---
status: deprecated
superseded_by: core-IColony.md
---

**Title:** MineColonies — IColony interface (colony state, managers, citizens, world lifecycle)
**Type:** fact
**Intent triggers:** IColony, onWorldLoad, onWorldUnload, onServerTick, getWorkManager, onWorldTick, getCenter, getName, setName, getPermissions, isCoordInColony, getDistanceSquared, getID, getTeamColonyColor, getColonyFlag, isDay, getLastContactInHours, getWorld, getRequestManager, markDirty, canBeAutoDeleted, getRequesterBuildingForPosition, removeVisitingPlayer, getMessagePlayerEntities, getWayPoints, getOverallHappiness, getStructurePack, setStructurePack, getServerBuildingManager, getCommonBuildingManager, getCitizenManager, getGraveManager, getVisitorManager, getAnimalManager, getRaiderManager, getEventManager, getReproductionManager, getEventDescriptionManager, getPackageManager, getTravellingManager, getConnectionManager, addVisitingPlayer, getDimension, isRemote, getResearchManager, usedMercenaries, getMercenaryUseTime, getColonyTag, isColonyUnderAttack, isValidAttackingPlayer, isValidAttackingGuard, setColonyColor, setColonyFlag, addWayPoint, addGuardToAttackers, addFreePosition, addFreeBlock, removeFreePosition, removeFreeBlock, setCanBeAutoDeleted, write, read, getImportantMessageEntityPlayers, useAdditionalChildTime, updateHasChilds, addLoadedChunk, removeLoadedChunk, getLoadedChunkCount, getLoadedChunks, getState, isActive, getTicketedChunks, setTextureStyle, getTextureStyleId, getNameStyle, setNameStyle, getCitizenNameFile, getStatisticsManager, getDay, getQuestManager, getCitizen, getSettings, writeToItemStack, ColonyState
**Source/evidence:** docs/api/minecolonies/colony/IColony.java — extracted from Desktop/minecolonies git repo (branch version/1.21, tag v1.21.1-1.1.1320-snapshot)
