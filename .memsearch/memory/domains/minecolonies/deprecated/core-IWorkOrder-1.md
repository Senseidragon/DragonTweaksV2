---
status: deprecated
superseded_by: core-IWorkOrder.md
---

**Title:** MineColonies — IWorkOrder interface (building construction/repair orders)
**Type:** fact
**Intent triggers:** IWorkOrder, getID, setID, getPriority, setPriority, getStructurePath, getStructurePack, loadBlueprint, getCurrentLevel, getTargetLevel, getTranslationKey, getWorkOrderType, getLocation, getRotationMirror, isClaimed, getClaimedBy, setClaimedBy, getDisplayName, getFileName, setBlueprint, getBlueprint, clearBlueprint, getBoundingBox, getColony, setColony, getStage, WorkOrderType, BuildingProgressStage, RotationMirror, Blueprint
**Source/evidence:** docs/api/minecolonies/colony/workorders/IWorkOrder.java — extracted from Desktop/minecolonies git repo (branch version/1.21, tag v1.21.1-1.1.1320-snapshot)
