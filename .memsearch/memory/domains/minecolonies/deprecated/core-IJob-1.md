---
status: deprecated
superseded_by: core-IJob.md
---

**Title:** MineColonies — IJob interface (citizen job system, AI, actions)
**Type:** fact
**Intent triggers:** IJob, ITickingStateAI, INBTSerializable, getJobRegistryEntry, setRegistryEntry, getModel, getColony, getAsyncRequests, createAI, generateAI, hasCheckedForFoodToday, setCheckedForFood, getNameTagDescription, setNameTag, triggerDeathAchievement, onStackPickUp, onLevelUp, initEntityValues, getCitizen, onWakeUp, canAIBeInterrupted, getActionsDone, incrementActionsDone, clearActionsDone, getWorkerAI, isIdling, resetAI, allowsAvoidance, getDiseaseModifier, onRemoval, ignoresDamage, markRequestSync, pickupSuccess, processOfflineTime, serializeToView, getInactivityLimit, getIdleSeverity, triggerActivityChangeAction, isGuard, getBuildingPos, getWorkBuilding, getWorkModule, assignTo, getSaturationFactor, JobEntry
**Source/evidence:** docs/api/minecolonies/colony/jobs/IJob.java — extracted from Desktop/minecolonies git repo (branch version/1.21, tag v1.21.1-1.1.1320-snapshot)
