---
status: deprecated
superseded_by: core-IRequestManager.md
---

**Title:** MineColonies — IRequestManager interface (colony request/delivery system)
**Type:** fact
**Intent triggers:** IRequestManager, INBTSerializable, ITickable, getColony, getFactoryController, createRequest, assignRequest, createAndAssignRequest, reassignRequest, getRequestForToken, getResolverForToken, getResolverForRequest, updateRequestState, overruleRequest, onProviderAddedToColony, onRequesterRemovedFromColony, onProviderRemovedFromColony, onColonyUpdate, getPlayerResolver, getRetryingRequestResolver, getDataStoreManager, reset, isDirty, setDirty, markDirty, log, serialize, deserialize, IRequestable, IToken, IRequester, IRequestResolverProvider, IPlayerRequestResolver, IRetryingRequestResolver, IDataStoreManager, IFactoryController, RequestState
**Source/evidence:** docs/api/minecolonies/colony/requestsystem/manager/IRequestManager.java — extracted from Desktop/minecolonies git repo (branch version/1.21, tag v1.21.1-1.1.1320-snapshot)
