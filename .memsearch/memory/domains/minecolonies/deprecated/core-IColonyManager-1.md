---
status: deprecated
superseded_by: core-IColonyManager.md
---

**Title:** MineColonies — IColonyManager interface (colony lifecycle, lookup, networking, client/server ticks)
**Type:** fact
**Intent triggers:** IColonyManager, getInstance, createColony, deleteColonyByWorld, deleteColonyByDimension, removeColonyView, getColonyByWorld, getColonyByDimension, getBuilding, getColonyByPosFromWorld, getColonyByPosFromDim, isFarEnoughFromColonies, getColonies, getAllColonies, getColoniesAbandonedSince, getBuildingView, getIColonies, getIColony, getColonyViews, getColonyView, getClosestIColony, getClosestColonyView, getClosestColony, getIColonyByOwner, getMinimumDistanceBetweenTownHalls, onServerTick, write, read, onClientTick, onWorldTick, onWorldLoad, onWorldUnload, handleColonyViewMessage, handlePermissionsViewMessage, handleColonyViewCitizensMessage, handleColonyViewWorkOrderMessage, handleColonyViewRemoveCitizenMessage, handleColonyBuildingViewMessage, handleColonyViewRemoveBuildingMessage, handleColonyViewRemoveWorkOrderMessage, isSchematicDownloaded, setSchematicDownloaded, isCoordinateInAnyColony, getCompatibilityManager, getRecipeManager, getTopColonyId, resetColonyViews, openReactivationWindow, addColonyDirect, addClaimData, getClaimData, addNewChunk
**Source/evidence:** docs/api/minecolonies/colony/IColonyManager.java — extracted from Desktop/minecolonies git repo (branch version/1.21, tag v1.21.1-1.1.1320-snapshot)
