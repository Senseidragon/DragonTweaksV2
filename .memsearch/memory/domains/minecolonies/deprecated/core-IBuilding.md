---
status: deprecated
superseded_by: core-IBuilding.md
---

**Title:** MineColonies — IBuilding interface (colony building, requests, modules, lifecycle)
**Type:** fact
**Intent triggers:** IBuilding, IBuildingContainer, IBuildingModuleContainer, IRequestResolverProvider, IRequester, ICommonBuilding, WOOD_HUT_LEVEL, getCustomName, getBuildingDisplayName, onWakeUp, onCleanUp, onRestart, onPlacement, onPlayerEnterNearby, onPlayerEnterBuilding, isMatchingBlock, destroy, onDestroyed, canBeBuiltByBuilder, markDirty, isPendingConstruction, removeWorkOrder, getClaimRadius, serializeToView, setCustomBuildingName, canBeGathered, requestUpgrade, requestRemoval, requestRepair, isBuilt, deconstruct, onUpgradeComplete, isGuardBuildingNear, resetGuardBuildingNear, buildingRequiresCertainAmountOfItem, getRequiredItemsAndAmount, forceTransferStack, createRequest, hasWorkerOpenRequests, getOpenRequests, hasWorkerOpenRequestsFiltered, hasOpenSyncRequest, hasWorkerOpenRequestsOfType, getOpenRequestsOfType, hasCitizenCompletedRequests, hasCitizenCompletedRequestsToPickup, getCompletedRequestsOfCitizenOrBuilding, getCompletedRequestsOfType, getCompletedRequestsOfTypeFiltered, markRequestAsAccepted, cancelAllRequestsOfCitizenOrBuilding, overruleNextOpenRequestWithStack, getOpenRequestsOfTypeFiltered, overruleNextOpenRequestOfCitizenWithStack, createPickupRequest, getResolvers, createResolvers, getRequester, getCitizenForRequest, reservedStacksExcluding, processOfflineTime, calculateCorners, isInBuilding, upgradeBuildingLevelToSchematicData, getOpenRequestsByRequestableType, pickUp, setBuildingType, onColonyTick, isItemStackInRequest, getMaxEquipmentLevel, canAssignCitizens, getAllAssignedCitizen, getHandlers, getSetting, getSettingValueOrDefault, canEat, writeToItemStack, getLocationsFromTag, canSort, sort, calculatePrestige, asyncPrestigeRecalc
**Source/evidence:** docs/api/minecolonies/colony/buildings/IBuilding.java — extracted from Desktop/minecolonies git repo (branch version/1.21, tag v1.21.1-1.1.1320-snapshot)
